    ...
    <div className="new-habit-card">
      <div className="habit-arguments">
        ...
        <input
          ...
          onChange={(e) => setHabitinfo((prev)=>({...prev,name:e.target.value}))}
        />
      </div>
      <div className="habit-arguments">
        ...
        <input
          ...
          onChange={(e) => setHabitinfo((prev)=>({...prev,repeate:e.target.value}))}
        />
      </div>
      <div className="habit-arguments">
        ...
        <input
          ...
          onChange={(e) => setHabitinfo((prev)=>({...prev,goal:e.target.value}))}
        />
      </div>
      <div className="habit-arguments">
        ...
        <input
          ...
          onChange={(e) => setHabitinfo((prev)=>({...prev,time:e.target.value}))}
        />
      </div>
      <div className="habit-arguments">
        ...
        <input
          ...
          onChange={(e) => setHabitinfo((prev)=>({...prev,SDate:e.target.value}))}
        />
      </div>
      <button
        onClick={() => {
